...
#define SCTLR_WXN               (0 << 19)
#define SCTLR_MMU_DISABLED      (0 << 0)
#define SCTLR_MMU_ENABLED       (1 << 0)


#define SCTLR_VALUE_MMU_DISABLED_CACHE_DISABLED	(SCTLR_RESERVED | SCTLR_WXN | SCTLR_EE_LITTLE_ENDIAN | SCTLR_I_CACHE_DISABLED | SCTLR_D_CACHE_DISABLED | SCTLR_MMU_DISABLED)
#define SCTLR_VALUE_MMU_DISABLED_CACHE_ENABLED	(SCTLR_RESERVED | SCTLR_WXN | SCTLR_EE_LITTLE_ENDIAN | SCTLR_I_CACHE_ENABLED | SCTLR_D_CACHE_ENABLED | SCTLR_MMU_DISABLED)
#define SCTLR_VALUE_MMU_ENABLED	    (SCTLR_RESERVED | SCTLR_WXN | SCTLR_EE_LITTLE_ENDIAN | SCTLR_I_CACHE_DISABLED | SCTLR_D_CACHE_DISABLED | SCTLR_MMU_ENABLED)
// ***************************************
