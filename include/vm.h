...
typedef enum {
    ...
    NORMAL_IO_WRITE_BACK_RW_ALLOCATION_NON_TRAINSIENT = 3 << 2
} mair_ind;
...
#define MT_NORMAL_IO_WRITE_BACK_RW_ALLOCATION_NON_TRAINSIENT       (3)
#define MT_NORMAL_IO_WRITE_BACK_RW_ALLOCATION_NON_TRAINSIENT_FLAGS (0b11111111ull)
#define MT_NORMAL_IO_WRITE_BACK_RW_ALLOCATION_NON_TRAINSIENT_VALUE (MT_NORMAL_IO_WRITE_BACK_RW_ALLOCATION_NON_TRAINSIENT_FLAGS << (8 * MT_NORMAL_IO_WRITE_BACK_RW_ALLOCATION_NON_TRAINSIENT))


#define MAIR_VALUE  (MT_DEVICE_VALUE | MT_NORMAL_NON_CACHABLE_VALUE | MT_NORMAL_IO_WRITE_BACK_RW_ALLOCATION_TRAINSIENT_VALUE | MT_NORMAL_IO_WRITE_BACK_RW_ALLOCATION_NON_TRAINSIENT_VALUE)
